...
angular
    ...
    function getPolicyConfiguredData() {
        ...
        adB2CSignInSignUpPolicy[network] = {
            ...
            oauth: {
                version: 2,
                auth: 'https://login.microsoftonline.com/tfp/' + tenantName + '/' + policy + '/oauth2/v2.0/authorize',
                grant: 'https://login.microsoftonline.com/tfp/' + tenantName + '/' + policy + '/oauth2/v2.0/token'
            },
            refresh: true,
            scope_delim: ' ',
        ...
        adB2CSignInSignUpPolicy[network].logout = function() {
            ...
            window.location = ('https://login.microsoftonline.com/' + tenantName + '/oauth2/v2.0/logout?p=' + policy + '&id_token_hint=' +
                id_token + '&post_logout_redirect_uri=https://login.microsoftonline.com/' + tenantName + '/oauth2/logout');
        };
